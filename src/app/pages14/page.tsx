...
export default function Home() {
  ...
  const {data} = useFetch("https://theofficeapi.dev/api/character/78");
  ...
  return (
    ...
    <div >
      <body style={{ backgroundColor: "#17c0f2" }}>
        ...
        <Avatar alt="Toby Flenderson" src="images/office15.jpg" sx={{ width: 200, height: 200}} 
        />
        </div>
        <div>
        <Stack spacing={2}>     
        ...
        <p style={{ fontFamily: 'American Typewriter Medium', alignItems: 'center', justifyContent: 'center', display: 'flex' }}><b>İliski: </b>{marital}</p>
